    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" style="border-radius: 2px;padding: 10px;font-size: 13px;"
...
<div class="menu-area navbar-fixed-top">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="mainmenu">
                    <div class="navbar navbar-nobg" style="text-align: center">
                        <div class="navbar-header">
                            <div class="fix-logo" style="display: none">
                                {{--@if(!Auth::check())
                                    <a href="/register">
                                ...
                                @endif--}}
                                <a href="/">
                                    <img style="" src="/site-assets/images/logo.png" width="148px" alt="">
                                </a>
                            </div>
...
@if(request()->getRequestUri()!='/')
    <section id="banner" class="row">
        <div class="col-md-12">
            @if($banner!=null)
                <img src="{{$banner->profile_image}}" alt="بنر تبلیغاتی">
            @else
                <h3 class="text-center">محل قرارگیری بنر تبلیغاتی</h3>
            @endif
        </div>
    </section>
@endif
